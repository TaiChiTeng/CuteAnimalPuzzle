...
export class UIManager extends Component {
    ...
    // UISelectPuzzleGroup/puzzleGroupScrollView：拼图组滚动视图
    // UISelectPuzzleGroup/itemPuzzleGroupPrefab：拼图组项预制体
    @property(Node)
    public UISelectPuzzleGroup: Node = null;
    
    private uiSelectPuzzleGroup: UISelectPuzzleGroup = null;

    // 选择难度和拼图界面（新增）
    // UISelectDifAndPuzzle/btnBack：点击返回拼图组选择界面
    // UISelectDifAndPuzzle/ToggleGroup/Toggle1：点击标记为9张拼图难度
    // UISelectDifAndPuzzle/ToggleGroup/Toggle2：点击标记为16张拼图难度
    // UISelectDifAndPuzzle/ToggleGroup/Toggle3：点击标记为25张拼图难度
    // UISelectDifAndPuzzle/ScrollView/view/content/itemSelectPuzzleX~itemSelectPuzzleY：点击根据拼图和难度，打开解决拼图界面
    @property(Node)
    public UISelectDifAndPuzzle: Node = null;
    
    private uiSelectDifAndPuzzle: UISelectDifAndPuzzle = null;
    ...
    @property(Node)
    public soundOnIconSelectPuzzleGroup: Node = null;

    @property(Node)
    public soundOffIconSelectPuzzleGroup: Node = null;

    @property(Button)
    public btnSoundSelectDifAndPuzzle: Button = null;

    @property(Node)
    public soundOnIconSelectDifAndPuzzle: Node = null;

    @property(Node)
    public soundOffIconSelectDifAndPuzzle: Node = null;
    ...
    public showSelectPuzzleGroupOnly(): void {
        ...
        // 调用界面显示回调
        if (this.uiSelectPuzzleGroup) {
            this.uiSelectPuzzleGroup.onShow();
        }
    ...
    public showSelectDifAndPuzzleOnly(groupIndex: number = 0): void {
        ...
        // 调用界面显示回调
        if (this.uiSelectDifAndPuzzle) {
            this.uiSelectDifAndPuzzle.onShow(groupIndex);
        }
    ...
    private initializeSoundButtons(): void {
        ...
        // 选择难度和拼图界面声音按钮（新增）
        this.btnSoundSelectDifAndPuzzle?.node.on(Button.EventType.CLICK, this.onSoundButtonClick, this);
    ...
    private updateAllSoundButtonStates(): void {
        ...
        // 更新选择难度和拼图界面声音按钮状态（新增）
        this.updateSoundButtonState(this.soundOnIconSelectDifAndPuzzle, this.soundOffIconSelectDifAndPuzzle, soundEnabled);
